                    ...
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="text-white-50 mb-0">Get your free Petrika account now</p>
                            ...
                            <div class="p-2">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">By registering you agree to the Poetrika <a href="#" class="text-primary">Terms of Use</a></p>
                                    </div>
                                </form>
                            </div>
