        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="section-title mb-4 pb-1 w-100">
                    <h2 class="m-0">More From <span> {{ucwords($word->categoryName)}}</span></h2>
                </div>
                <div class="post-tabs">
                        ...
                        <div class="author-news mb-4 box-shadow p-4 text-center">
                            <div class="author-news-content">
                                <div class="author-thumb mb-1">
                                    <img src="@if($word->userPhoto == null)
                                        {{url('public/noImage.jpeg')}} @else
                                        {{asset('/profiles/'.$word->userPhoto)}}
                                    @endif" alt="{{ucwords($word->userName)}}">
                                </div>
                                <div class="author-content">
                                    <h3 class="title mb-1"><a href="#">About {{ucwords($word->userName)}}</a></h3>
                                    <p class="mb-2">
                                        @if($word->bio == null) No Bio
                                        Yet! @else  {!! $word->bio !!} @endif
                                    </p>
                                    <div class="header-social">
                                        <ul>
                                            <li><a href="tel:{{$word->phone}}"><i class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:{{$word->email}}"><i class="fa fa-send"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sidebar-item mb-4">
                            ...
                            <ul class="sidebar-category">
                                @foreach($categories as $category)
                                    <li style="font-size: 13px" @if($category->id == $word->category) class="active" @endif><a href="{{route('viewPoetryByCategories',$category->id)}}">{{strtoupper($category->name)}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
