<form action="{{route('send_inquire')}}" method="post" class="">
    ...
    <div class="row col-lg-12">
        ...
        <div class="col-lg-6">
            ...
            <input type="text" required placeholder="Enter Your Full Name" name="name" value="" size="40" class="form-control" />
        </div>

        <div class="col-lg-6">
            <input type="email" required name="email" placeholder="Enter Your Email" value="" size="40" class="form-control" />
        </div>
    </div>
    <p><br>
