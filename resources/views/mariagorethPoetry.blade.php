            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                    <div class="cover-content">
                        <h1 style="font-size: 45px">{{ucwords("Mariagoreth's Poetry")}}</h1>
                        <img style="width:100%;object-fit: contain" src="{{asset('public/title.png')}}" alt="{!! strtoupper($about->name) !!}" class="w-100">
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="box-shadow p-3">
                        @if($about->getFirstMedia())
                            <img style="border-radius: 10% ;width:100%;object-fit: contain" src="{{$about->getFirstMediaUrl()}}" alt="{!!  strtoupper($about->name) !!}" class="w-100">
                        @else
                            <img style="border-radius: 10% ; width:100%;object-fit: contain" src="{{url('public/noImage.jpeg')}}" alt="{!!  strtoupper($about->name) !!}" class="w-100">
                        @endif
                    </div>
                </div>
            </div>
